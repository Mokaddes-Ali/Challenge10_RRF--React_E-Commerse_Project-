  ...
  return (
    <>
      <div className="lg:w-[1440px] relative">
        {/* Header Navbar Title*/}
        <nav className="nav bg-black text-white md:px-0 md:h-[38px] lg:pt-[9px]">
          <div className="flex-center">
            <h1 className="text-[14px] font-normal not-italic leading-normal">
              Sign up and get 20% off to your first order.
            </h1>
            <span className="text-[14px] font-normal not-italic leading-normal underline decoration-solid decoration-skip-ink-none decoration-auto underline-offset-auto">
              Sign Up Now
            </span>
          </div>
        </nav>

        <div className="relative custom-container lg:h-[48px] lg:absolute lg:top-[72px] lg:left-[100px]">
          <div className="flex">
            {/* Company Logo */}
            <div className="logo lg:w-2/12">
              <img src={logo} alt="Company Logo" className="" />
            </div>
            {/* menu bar */}
            <div className="w-4/12 absolute left-[199px] top-[8px]">
              <ul className="flex space-x-[23px]">
                <li>
                  <a href="/" className="menu-text flex items-center gap-1">
                    Shop
                    <span className="">
                      <svg
                ...
                <li>
                  <a href="/" className="flex items-center gap-1 menu-text">
                    On Sale
                  </a>
                </li>
                <li>
            ...
            {/* SearchBar Option */}
            <div className="absolute left-[560px] -top-[10px] w-4/12">
              <form className="flex items-start gap-3 flex-[1_0_0] py-[12px] px-4 rounded-[62px] bg-[#F0F0F0] w-[577px] h-[48px]">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
                ...
                <input
                  ...
                  className="flex-1 bg-transparent outline-none placeholder:text-black/40 placeholder:font-satoshi placeholder:text-base placeholder:font-normal"
                />
              </form>
            </div>

            {/* User And Cart Icon */}
            <div className="absolute flex gap-[14px] left-[1180px] top-[2px] w-2/12">
